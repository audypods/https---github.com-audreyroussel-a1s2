...
public class Main {
	...
	/**
	 * Methode qui affiche le menu et demande le nombre de joueurs
	 */
		...
		while (m<=169){
			...
			if (nbreJoueurs==1){
				if (m%2!=0 && m!=2){
					...
					Grille.stepJoueur(couleurs, compteurControle1, compteurControle2, 1);
				}
				else {
				...
				if (m%2!=0 && m!=2){
					...
					Grille.stepJoueur(couleurs, compteurControle1, compteurControle2, 2);
				}	
			}
